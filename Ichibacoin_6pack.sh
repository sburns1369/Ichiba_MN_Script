...
if [[ "$MN5" -eq "0" ]]; then
sudo cp -r /home/ichibacoin/.ichibacoin/* /home/ichibacoin5/.ichibacoin
...
if [[ "$MN6" -eq "0" ]]; then
sudo cp -r /home/ichibacoin/.ichibacoin/* /home/ichibacoin6/.ichibacoin
...
echo -e ${BLUE}" IchibaCoin address: BayScFpFgPBiDU1XxdvozJYVzM2BQvNFgM"${CLEAR}
